...
import { PureToken } from "../../hardhat/types/PureToken";

export function PureTokenContract({ contractData }) {
  ...
  return (
    <Grid sx={{ m: 1 }} container justifyContent="center">
      <Grid item sm={6} xs={12} sx={{ m: 2 }}>
        <Typography variant="h5">Pure Token Contract:</Typography>
        {contractData ? (
        ...
        <Button sx={{ m: 1, marginLeft: 0 }} variant="contained" onClick={convertToGovToken}>
          Convert To Pure Governance Token
        </Button>
        <Divider sx={{ m: 1 }} />
